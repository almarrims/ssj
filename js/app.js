...
const moveToPlay = function () {
    ...
    playerOne = document.querySelector('.thenames1').value || 'اللاعب 1';
    document.querySelector('.name1').innerText = playerOne;
    if (document.querySelector('.thenames2').value) {
        playerTwo = document.querySelector('.thenames2').value || 'اللاعب 2';
...
const scoring = function (score1 = 0, score2 = 0, scoretie = 0) {
    ...
    result1.innerText = score1 + ' فوز ';
    result2.innerText = score2 + ' فوز ';
    tie.innerText = scoretie + ' تعادل ';
